...
describe('Check User', function (user) {
  var userValid = 'Marion'
  var userUndefined
  var userNull = null
  var userNoChar = ''
  var userAboveFifty = 'Marion Marion Marion Marion Marion Marion Marion Marion Marion Marion Marion Marion'
